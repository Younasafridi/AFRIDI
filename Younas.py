...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:You as_Afridi
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtu.be/jPyOrOcmk6c')

    else:

        print "\033[1;96mWrong Username"

        os.system('xdg-open https:/https://youtu.be/jPyOrOcmk6c/')
...
def menu():
	...
	os.system("clear") #Dev:Younas_Afridi
...
: \033[1;96m ....Y O U N A S  A F R I D I ...... \033[1;93m :

•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 

               SO  SO  FASTEST COMMAND
